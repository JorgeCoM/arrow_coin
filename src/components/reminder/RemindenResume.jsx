export const RemindenResume = () => {
  return (
    <div className="w-full h-full flex flex-col">
      <div className="w-full h-[30px] mb-4 flex justify-between items-baseline">
        <h2 className="text-white">Recordatorios</h2>
        <button className=" font-thin">Ver todos</button>
      </div>
      <div className="w-full h-full flex flex-col">
